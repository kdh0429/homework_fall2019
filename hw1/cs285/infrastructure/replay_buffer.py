...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        rand_idx = np.random.permutation(np.arange(self.obs.shape[0]))[:batch_size]
        return self.obs[rand_idx], self.acs[rand_idx], self.rews[rand_idx], self.next_obs[rand_idx], self.terminals[rand_idx]
